...
while($productrow = mysqli_fetch_array($selectq))
{
    ...
    echo "<tr>";
      ...
      echo "<td>{$productrow['pro_price']}</td>";
       echo "<td><a href = 'edit-product.php?eid={$productrow['pro_id']}'><img style='width:16px;' src='my-images/edit.png'>Edit</a> | <a href = 'display-product.php?did={$productrow['pro_id']}'><img style='width:16px;' src='my-images/delete.png'>Delete</a></td>";
     echo "</tr>";
}
?>
